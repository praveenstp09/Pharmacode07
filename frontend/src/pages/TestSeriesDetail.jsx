  ...
  return (
    <div className="min-h-screen py-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
              ...
              <div className="bg-white/10 backdrop-blur rounded-xl p-3 border border-white/10">
                ...
                <span className="font-bold text-sm sm:text-base text-white">{pyqsList.length} Official PYQs (CBT + PDF)</span>
              </div>
              <div className="bg-white/10 backdrop-blur rounded-xl p-3 border border-white/10">
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-6 sm:p-8 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-4">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Explore CBT mock tests, official PYQ exams & PDFs, and subject-wise CBT drills. Free demo items are unlocked!
            </p>
          </div>
        </div>
                    ...
                    <div className="flex items-start space-x-3.5">
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-3 text-[11px] text-indigo-700 font-semibold mt-1">
                          ...
                          <span>•</span>
                          <span>📄 Solved PDF Available</span>
                        </div>
                      </div>
                    </div>
        ...
        {/* FOLDER 3: SUBJECT-WISE CBT DRILLS (CBT ONLY) */}
        {activeFolderTab === 'subjectWise' && (
          <div className="space-y-6">
            {subjectKeys.length > 0 ? (
                    ...
                    return (
                      ...
                      >
                        <div>
                          ...
                          <p className="text-xs text-slate-500 mt-1">
                            Focused sectional CBT drill for {activeSubject} • {item.totalQuestions || 50} MCQs
                          </p>
                        </div>
              ...
              <p className="text-center text-sm text-slate-500 py-8">No subject-wise CBT tests uploaded yet.</p>
            )}
          </div>
        )}
      </div>
