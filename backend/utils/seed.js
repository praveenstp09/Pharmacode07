...
const seedDatabase = async () => {
  try {
    ...
    console.log('✅ Connected to MongoDB Atlas! Clearing old data...');
    ...
    console.log('📦 Creating GSSSB Junior Pharmacist 120 MCQ Model Papers...');
    ...
    // High Yield Pharmacy Questions Pool
    ...
    console.log('📚 Creating Study Materials & PYQs...');
